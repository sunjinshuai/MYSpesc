...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/s_mike@163.com/ComponentA'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 's_mike@163.com' => 's_mike@163.com' }
  s.source           = { :git => 'https://github.com/s_mike@163.com/ComponentA.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'ComponentA/Classes/**/*'
  s.dependency 'IMXInterface'
  s.dependency 'IMXModule'
  s.dependency 'IMXRoute'
